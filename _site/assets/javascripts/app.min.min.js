...
angular.module('app', ['app.states', 'app.factories', 'app.components']).controller('ctrl', ['$scope', '$http', 'apiRealTimeQuotes', function ($scope, $http, apiRealTimeQuotes) {
...
angular.module('app.components').component('componentCompany', {
  bindings: {
    user: '=',
    symbol: '@'
  },
...
angular.module('app.components').component('componentFeed', {
  bindings: {
    user: '=',
    quotes: '='
  },
...
angular.module('app.components').component('componentPortfolio', {
  bindings: {
    user: '=',
    quotes: '='
  },
...
angular.module('app.components').component('componentQuotes', {
  bindings: {
    quotes: '='
  },
  templateUrl: 'assets/javascripts/components/quotes/view.html',
  controller: function controller() {}
});
'use strict';

angular.module('app.components').component('componentSettings', {
  bindings: {
    user: '='
  },
