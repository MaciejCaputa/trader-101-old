...
angular.module('app.components', ['app']).component('componentFeed', {
  bindings: {
    user: '=',
    quotes: '='
  },
...
.component('componentSignup', {
  ...
  controller: function controller($state, $scope) {
    ...
    $scope.$watch('this.user', function () {
      console.info(_this2.user);
      console.info(_this2.user);
      console.info(_this2.user);
    });

    this.signUp = function () {
      firebase.auth().createUserWithEmailAndPassword(_this2.signup.email, _this2.signup.password).catch(function (error) {
        _this2.signup.errorMessage = error.message;
        // this.$apply();
        ...
        firebase.auth().currentUser.updateProfile({
          displayName: _this2.signup.firstName + ' ' + _this2.signup.lastName,
          photoURL: 'https://maciejcaputa.com/assets/images/thumbnail-face.jpg'
        }).then(function () {
          firebase.database().ref('users/' + firebase.auth().currentUser.uid).set({
            firstName: _this2.signup.firstName,
            lastName: _this2.signup.lastName,
            name: _this2.signup.firstName + ' ' + _this2.signup.lastName,
            email: _this2.signup.email,
